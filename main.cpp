...
#include <windows.h>
#include <cstdlib>
/*Нужно создать класс студента, чтобы записывать каждого студента в вузе в базу данных. У каждого студента должен быть рот, которым он сможет объяснять свои опоздания ограниченным кол-вом предлжений.*/
class mouth{
    public:
